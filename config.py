...
RIGHT = 1
PARTS = [
	('L_FRONT', LEFT, 0, 0, 0, 0),
	('R_FRONT', RIGHT, 0, 0, 0, 0),
	('L_TOP', LEFT, -90, 0, -90, 0),
	('R_TOP', RIGHT, -90, 0, -90, 0),
	('L_BOTTOM', LEFT, 90, 0, 90, 0),
	('R_BOTTOM', RIGHT, 90, 0, 90, 0),
	('L_LEFT', LEFT, 0, 90, 0, -90),
	('R_LEFT', RIGHT, 0, 90, 0, -90),
	('L_RIGHT', LEFT, 0, -90, 0, 90),
	('R_RIGHT', RIGHT, 0, -90, 0, 90),
	# The following are the half-parts used in the "remove visible stitches" trick
